class Game {
  ...
  start() {
    ...
    car1.addImage("car1smokedblack", car1smokedImg);
    car1.addImage("car1fire", car1fireImg);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("blast", blastImage); //C42//AA
    car2.addImage("car2smoked", car2smokedImg);
    car2.addImage("car2smokedblack", car2smokedImg);
    car2.addImage("car2fire", car2fireImg);
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if(currentlife <= 138.75 ){
          carm1[index - 1].changeImage("car1smoked");
          carm1[index - 1].scale = 0.3;
        ...
        if (index === player.index) {
          ...
          if(player.life <= 138.75 ){
            this.car1smoked = true;
            this.car2smoked = true;
          }
